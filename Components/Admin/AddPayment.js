...
const AddPayment = () => {
    ...
    const getCurrentDate = () => {
        ...
        return `${year}-${month}-${day}`; // Use template literals here
    };
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('http://192.168.43.163:1503/addpayment', {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            >
                ...
                <Picker.Item label="Fruit Juices" value="Fruit Juices" />
                <Picker.Item label="Shakes" value="Shakes" />
                <Picker.Item label="Vegetable Juices" value="Vegetable Juices" />
