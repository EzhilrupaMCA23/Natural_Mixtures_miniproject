...
const RegisterScreen = ({ navigation }) => {
    ...
    const handleRegistration = async (values) => {
        ...
        try {
            const response = await axios.post('http://192.168.43.163:1503/register', formData);
    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <ImageBackground 
                source={require('../../assets/back6.jpg')} // Make sure the path is correct
                style={styles.container}
                resizeMode="cover"
            >
                <Text style={styles.title}>Welcome to Natural Mixtures</Text>
